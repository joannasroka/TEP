...
void test() {
	...
	*/
	 ...
	 */
	 ...
	 double* randomSearchSolution;
	 double* bestQuality = new double(0.0);

	MscnProblem* mscnLista10 = new MscnProblem(2, 2, 3, 2);
	(*mscnLista10).generateInstance(4);

	RandomSearch randomSearch(mscnLista10, 4);
	randomSearchSolution = randomSearch.createSolution(mscnLista10, bestQuality);
	//cout << *bestQuality << endl;

	cout << (*mscnLista10).getQuality(randomSearchSolution, sizeSolution, isCorrect); // z randomSearchem
	//cout<<(*mscnLista10).getQuality(solution, sizeSolution, isCorrect); // bez randomSearcha
	cout << endl;
	cout << (*mscnLista10).getQuality(randomSearch.swapHalfBestSolution(mscnLista10, randomSearchSolution, sizeSolution), sizeSolution, isCorrect);
	cout << endl;
	cout << (*mscnLista10).getQuality(randomSearch.swapHalfBestSolution(mscnLista10, randomSearchSolution, sizeSolution), sizeSolution, isCorrect);
